...
_FLAVOR_LINES = [
    ...
    "Blowing in the cartridge again, harder this time...",
    "Checking the cartridge is the right way up...",
    "Un-jamming the tape deck...",
    "Rewinding to the start of side B...",
    "Waiting for the dial-up tone...",
    "Feeding a quarter to the cabinet...",
    "Looking for Player 2...",
    "Checking under the couch cushions for a memory card...",
    "Praying to the RNG gods...",
    "Bribing the boss for an extra continue...",
    "Reformatting the memory card (kidding)...",
    "Un-pausing reality...",
    "Turning it off and on again...",
    "Asking the Konami Code nicely...",
    "Making sure the disc isn't upside down...",
    "Recalibrating the light gun...",
    "Waiting out the studio logos...",
    "Skipping the unskippable cutscene...",
    "Saving before the boss fight, just in case...",
    "Untangling two controller cords into one...",
    "Explaining to the cat why the console is loud...",
    "Wiping dust off the disc with a t-shirt...",
    "Double-checking this isn't a Monday...",
    "Consulting the strategy guide...",
    "Pressing Start to continue (there is no Start)...",
    "Letting the loading screen tips finish...",
    "Negotiating a truce with the save file...",
    "Un-muting the TV (it was never muted)...",
    "Waiting for the eject button to stop being tempting...",
]
